...
(defn sqrt-iter-original [guess x]
...
; Ordinary procedures uses of applicative-order of evaluation
; and defining if as ordinary procedures leads to evaluation
; of else clause, that results in stack overflow.
