...
; Please note that p is defined recursively. An interpreter that
; uses applicative-order of evaluation will produce an infinite
; loop. On the other hand, an interpreter that uses normal-order
; of evaluation will return 0.
