; Exercise 2.23: Thee procedure for-each is similar to map. It takes as
...
; elements in turn, from left to right. Thee values returned by applying the
; procedure to the elements are not used at all—for-each is used with procedures
...
(for-each println (list 57 321 88))     ; 57 321 88
